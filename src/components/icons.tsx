...
export const TelegramIcon = (props: IconType) => (  
  <svg
    stroke="currentColor"
    fill="currentColor"
    strokeWidth="0"
    ...
    xmlns="http://www.w3.org/2000/svg"
  >
    <path d="M248 8C111 8 0 119 0 256s111 248 248 248 248-111 248-248S385 8 248 8zm114.9 169.4l-40.7 191.9c-3.1 13.8-11.3 17.2-22.8 10.7l-63.1-46.5-30.5 29.4c-3.4 3.4-6.2 6.2-12.7 6.2l4.5-64.2 116.8-105.5c5.1-4.5-1.1-7-7.9-2.5l-144.3 90.9-62.1-19.4c-13.5-4.2-13.8-13.5 2.8-20l242.7-93.6c11.3-4.2 21.2 2.8 17.3 20.6z" />
  </svg>
);
